...
Ansible Role for CIS Red Hat Enterprise Linux 10 Benchmark for Level 1 - Workstation  
...
Run `ansible-galaxy install RedHatOfficial.rhel10_cis_workstation_l1` to
download and install the role. Then, you can use the following playbook snippet to run the Ansible role:

    - hosts: all
      roles:
         - { role: RedHatOfficial.rhel10_cis_workstation_l1 }
